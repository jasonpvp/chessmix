...
fn get_move(board: &chess::Board, piece_value: i32, piece_turn: bool, from_cell: [usize; 2], to_cell: [usize; 2], capture: bool) -> chess::Move {
  let i = to_cell[0];
  let j = to_cell[1];
  ...
  chess::Move {
    ...
    valid: piece_turn && ((!occupied && !capture) || (occupied && capture && other))
  }
}
